...
class OFim_AdminCrawl_Controller{
    ...
    public function display(){
        $categoryFromApi = $this->cache->remember('movie_the_loai', OFIM_CACHE_TIME, function() {
            try {
        ...
        $countryFromApi = $this->cache->remember('movie_quoc_gia', OFIM_CACHE_TIME, function() {
            try {
    ...
    public function getLastLog() {
        $log_path = WP_CONTENT_DIR  . '/crawl_movie_logs';
