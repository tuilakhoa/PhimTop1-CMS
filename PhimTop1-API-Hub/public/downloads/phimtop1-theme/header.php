...
<body <?php body_class('bg-[#0f1115] text-gray-300 font-sans antialiased'); ?>>
    ...
    ?>
    <header class="bg-[#0f1115]/80 backdrop-blur-xl border-b border-gray-800/50 sticky top-0 z-50 transition-all">
        <div class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="<?php echo home_url(); ?>" class="text-xl font-extrabold text-white flex items-center gap-2 hover:opacity-80 transition-opacity">
                <i class="fas fa-play-circle text-kk-red text-2xl"></i> <span class="tracking-tight"><?php bloginfo('name'); ?></span>
            </a>
            <nav class="hidden md:flex items-center gap-1 font-semibold text-[13px]">
                ...
                <div class="relative group h-full flex items-center">
                    ...
                    <div class="absolute left-0 top-full mt-2 w-[450px] bg-[#181a20] border border-gray-800 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 grid grid-cols-3 p-4 gap-2 z-50">
                ...
                <div class="relative group h-full flex items-center">
                    ...
                    <div class="absolute left-0 top-full mt-2 w-[300px] bg-[#181a20] border border-gray-800 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 grid grid-cols-2 p-4 gap-2 z-50">
