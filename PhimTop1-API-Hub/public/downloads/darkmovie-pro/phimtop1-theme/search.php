<?php get_header(); ?>
    <div class="max-w-[1440px] mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8 border-b border-gray-800 pb-4">
            <h2 class="text-2xl font-bold text-white border-l-4 border-kk-red pl-3">
                Kết quả tìm kiếm cho: <span class="text-kk-red">"<?php echo get_search_query(); ?>"</span>
            </h2>
        </div>
        ...
        <?php endwhile; else: ?>
            <div class="col-span-full py-20 text-center">
                ...
                <p class="text-gray-500 text-lg">Không tìm thấy phim nào khớp với từ khóa của bạn.</p>
            </div>
        <?php endif; ?>
        </div>
