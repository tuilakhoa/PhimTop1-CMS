...
<div class="relative w-full flex -mt-20 overflow-hidden" style="min-height: 70vh; align-items: flex-end; padding-bottom: 3rem; padding-top: 7rem;">
    ...
    <div class="absolute inset-0 z-0 bg-black">
        <img fetchpriority="high" src="<?= htmlspecialchars(!empty($movie['poster_url']) ? $movie['poster_url'] : $movie['thumb_url']) ?>" alt="<?= htmlspecialchars($movie['name']) ?>" class="w-full h-full object-cover opacity-40 blur-2xl scale-110">
        <!-- Gradients to blend -->
