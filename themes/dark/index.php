...
<div class="swiper-wrapper" id="ai-recommend-list">
                    ...
                    <?php for($i=0; $i<6; $i++): ?>
                        <div class="swiper-slide group shrink-0 w-[130px] sm:w-[150px] md:w-[170px] block">
                ...
                .then(res => {
                    if (res.status === 'success' && res.data && res.data.length > 0) {
                        ...
                        res.data.forEach(item => {
                            ...
                            html += `
                                <a href="/phim/${item.slug}" class="swiper-slide group shrink-0 w-[130px] sm:w-[150px] md:w-[170px] block">
...
<div class="swiper-wrapper">
                    ...
                    ?>
                    <a href="/<?= $settings["slugMovie"] ?? "phim" ?>/<?= urlencode($item['slug']) ?>" class="swiper-slide group shrink-0 w-[150px] sm:w-[180px] md:w-[200px] block relative flex items-end pt-8">
