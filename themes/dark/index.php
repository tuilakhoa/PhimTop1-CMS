...
<div class="swiper-wrapper">
                    ...
                    ?>
                        <a href="<?= $historyLink ?>" class="swiper-slide group shrink-0 w-52 sm:w-60 md:w-72 block">
...
<div class="swiper-wrapper" id="ai-recommend-list">
                    ...
                    <?php for($i=0; $i<6; $i++): ?>
                        <div class="swiper-slide group shrink-0 w-32 sm:w-40 md:w-48 block">
                ...
                .then(res => {
                    if (res.status === 'success' && res.data && res.data.length > 0) {
                        ...
                        res.data.forEach(item => {
                            ...
                            html += `
                                <a href="/phim/${item.slug}" class="swiper-slide group shrink-0 w-32 sm:w-40 md:w-48 block">
...
<div class="swiper-wrapper">
                    ...
                    ?>
                    <a href="/<?= $settings["slugMovie"] ?? "phim" ?>/<?= urlencode($item['slug']) ?>" class="swiper-slide group shrink-0 w-32 sm:w-40 md:w-48 block relative">
