...
<div class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <!-- Video Player -->
    <div class="mb-6 bg-black rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
        <div class="aspect-video w-full bg-black relative flex items-center justify-center group" id="player-container">
            ...
            <?php else: ?>
                <div class="text-gray-900 text-center p-8">
        ...
        <div class="p-5 bg-gray-50 border-t border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 mb-1"><a href="/<?= $settings["slugMovie"] ?? "phim" ?>/<?= urlencode($slug) ?>" class="hover:text-red-500 transition-colors"><?= htmlspecialchars($movie['name']) ?></a></h1>
                <h2 class="text-lg text-gray-700">Đang xem: Tập <?= htmlspecialchars($currentEp['name']) ?></h2>
            </div>
            <div class="flex items-center space-x-3">
                <span class="px-3 py-1.5 bg-white text-gray-700 rounded-lg text-sm font-medium border border-gray-300">
        ...
        <div class="bg-gray-50 rounded-2xl p-6 border border-gray-200 shadow-xl">
            ...
            <div class="flex flex-wrap gap-2 max-h-[300px] overflow-y-auto custom-scrollbar p-2">
                <?php foreach ($episodes[0]['server_data'] as $e): 
                    ...
                    $classes = $isActive 
                        ? "bg-red-600 text-gray-900 shadow-lg shadow-red-600/30 font-bold transform scale-105 ring-2 ring-red-400 ring-offset-2 ring-offset-gray-900" 
                        : "bg-white text-gray-700 hover:bg-gray-200 hover:text-gray-900 border border-gray-300";
                ?>
    ...
    <div class="mt-12 mb-12">
        <h3 class="text-xl font-bold text-gray-900 mb-6 border-l-4 border-red-500 pl-3">Có Thể Bạn Sẽ Thích</h3>
